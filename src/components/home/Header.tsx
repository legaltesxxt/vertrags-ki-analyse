...
const Header = () => {
  ...
  return <section className="mb-12 text-center animate-fade-in">
      ...
      <p className="text-slate-600 max-w-3xl mx-auto mb-8 text-lg leading-relaxed">Vertragsklar analysiert Schweizer Arbeits- und Mietverträge mithilfe modernster künstlicher Intelligenz</p>
      
      <div className="flex flex-col items-center justify-center gap-4">
        <Button onClick={scrollToFileUpload} className="bg-legal-primary hover:bg-legal-primary/90 text-white px-5 py-2 text-base font-medium rounded-lg" size="default">
