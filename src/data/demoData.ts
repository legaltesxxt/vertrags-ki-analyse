...
export const emptyAnalysisData: AnalysisResult = {
  clauses: [],
...
export const arbeitsvertragDemo: AnalysisResult = {
  clauses: [
    {
      id: "clause-1",
...
export const mietvertragDemo: AnalysisResult = {
  clauses: [
    {
      id: "clause-1",
      title: "Vertragsparteien",
    ...
    },
    {
      ...
      lawReference: {
        text: "OR Art. 255: Der Mietvertrag muss, wenn er für Wohn- oder Geschäftsräume abgeschlossen sein, schriftlich abgefasst sein, wenn ihn eine Partei verlangt.",
        link: ""
      },
