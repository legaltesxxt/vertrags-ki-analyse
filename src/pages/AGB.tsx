...
*Vertragsklar – Vertragsanalyse-Service*  
*(Stand: Mai 2025)*

## 1. Geltungsbereich  
Diese Allgemeinen Geschäftsbedingungen (AGB) regeln das Verhältnis zwischen „Vertragsklar", einem Einzelunternehmen mit Sitz in Bellmund, Schweiz, und natürlichen oder juristischen Personen (nachfolgend „Nutzer"), die über die Website von Vertragsklar eine KI-gestützte Analyse von Vertragsdokumenten in Anspruch nehmen.

## 2. Leistungsumfang  
Vertragsklar bietet eine automatisierte Analyse hochgeladener Verträge (z. B. Arbeits-, Miet- oder Werkverträge) durch ein KI-System (OpenAI) an. Die Analyse liefert eine Einschätzung der rechtlichen Risiken und verweist auf relevante Gesetzesartikel.
...
Die Nutzung erfolgt auf Abruf (Pay-per-Use). Mit dem Hochladen eines Vertragsdokuments und der Zahlung des Analysepreises kommt ein Vertrag zwischen dem Nutzer und Vertragsklar zustande.
...
Vertragsklar bemüht sich um die grösstmögliche Genauigkeit der KI-Ausgabe. Dennoch wird keine Haftung übernommen für:
...
Vertragsklar schliesst jede Haftung im gesetzlich zulässigen Umfang aus, insbesondere für leichte Fahrlässigkeit.
...
Die Analyseergebnisse und die zugrunde liegende Software bleiben geistiges Eigentum von Vertragsklar bzw. der jeweiligen Lizenzgeber. Eine Vervielfältigung oder kommerzielle Weitergabe ohne Zustimmung ist unzulässig.

## 8. Schlussbestimmungen  

- **Anwendbares Recht:** Es gilt Schweizer Recht.  
- **Gerichtsstand:** Zuständig ist das Gericht am Sitz von Vertragsklar.  
- Sollten einzelne Klauseln dieser AGB unwirksam sein, bleibt die Wirksamkeit der übrigen unberührt.

---

**Vertragsklar** – Schatzacher 16, 2564 Bellmund, info@vertragsklar.ch  
